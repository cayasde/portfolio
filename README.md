...
I’m 17 years old and a Fullstack Roblox scripter with over 3 years of experience. Based in Brazil, I started coding in 2023 with Roblox development, then expanded into JavaScript and TypeScript, building websites, Discord bots, and scalable Roblox systems.
...
| [StyLua](https://github.com/JohnnyMorganz/StyLua)               | Formatter for Lua/Luau code.                                                 |
| [Pesde](https://github.com/pesde-pkg/pesde)                     | Luau package manager for dependency resolution.                              |
| [Asphalt](https://github.com/jackTabsCode/asphalt)              | Upload Roblox assets and generate typed references.                          |
| [Git](https://git-scm.com/)                                     | Distributed version control system.                                          |
| [Github](https://github.com/)                                   | Git hosting, code review, and CI workflows.                                  |
| [Blink](https://github.com/1Axen/blink)                         | IDL compiler generating typed buffer networking code.                        |
| [Lune](https://github.com/lune-org/lune)                        | Standalone Luau runtime with FS, networking, etc apis.                       |
| [Darklua](https://github.com/seaofvoices/darklua)               | Transform, bundle, and minify Lua/Luau via CLI.                              |
| [Mantle](https://github.com/blake-mealey/mantle)                | Define and deploy Roblox experiences through CI/CD.                          |
| [Re-test](https://github.com/ernisto/re-test)                   | Minimal CLI for automated Luau tests.                                        |
| [UiLabs](https://github.com/PepeElToro41/ui-labs)               | Storybook-style UI component preview for Roblox.                             |
| [Conch](https://github.com/alicesaidhi/conch)                   | Console that makes it easy to register and run developer commands            |
| [Promise](https://github.com/evaera/roblox-lua-promise)         | Promise/A+ async abstraction for Luau.                                       |
| [Rokit](https://github.com/rojo-rbx/rokit)                      | Roblox toolchain version manager.                                            |
| [Wally](https://github.com/UpliftGames/wally)                   | Package manager for Roblox dependencies.                                     |
| [ProfileStore](https://github.com/MadStudioRoblox/ProfileStore) | Reliable player data wrapper over DataStore.                                 |
| [Spr](https://github.com/Fraktality/spr)                        | Spring-based animation library for Roblox.                                   |
